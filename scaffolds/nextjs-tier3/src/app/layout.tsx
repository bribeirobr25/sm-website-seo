...
export const metadata: Metadata = {
  ...
  // Demo phase: noindex via robots. Flip at production cutover.
    ...
    <html lang={SITE.locale}>
      <head>
        ...
        {/*
          ...
          The CookieBanner script upgrades these on consent.
