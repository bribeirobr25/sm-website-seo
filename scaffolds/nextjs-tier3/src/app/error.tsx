  ...
  return (
    <main id="main" className="section">
      <div className="container-page max-w-xl text-center">
        <p className="text-xs uppercase tracking-[0.2em] text-warning font-medium">Error 500</p>
        <h1 className="mt-4 font-display text-4xl md:text-5xl text-text">
          Something went wrong.
        </h1>
        <p className="mt-5 text-text-muted leading-relaxed">
          We've captured the error and are looking into it. Please try again, or get in touch if
          the issue persists.
        </p>
        ...
        {error.digest && (
          <p className="mt-8 text-xs text-text-muted tabular">Reference: {error.digest}</p>
        )}
      </div>
    </main>
  );
