...
export const PORTFOLIO: readonly PortfolioEntry[] = [
  ...
  },
  {
    ...
    services: ['website'],
    stackBadge: 'Web application interface',
    shortDescription: {
    ...
    longDescription: {
      en: 'Internal tool for retail store managers. Daily-plan layout with team check-in, registers, KPI tiles, PDF export. German and English.',
      de: 'Internes Tool für Filialleiter:innen im Einzelhandel. Tagesplan-Layout mit Team-Check-in, Kassen, KPI-Kacheln, PDF-Export. Deutsch und Englisch.',
      'pt-br':
        'Ferramenta interna para gerentes de loja no varejo. Layout de plano diário com check-in da equipe, caixas, tiles de KPIs, exportação em PDF. Alemão e inglês.',
    },
  },
];
