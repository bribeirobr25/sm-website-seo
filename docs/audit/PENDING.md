...
**Last updated:** 2026-05-18 (SEO-DEPTH-EXPANSION-PLAN **Batch 2 complete** — all 8 slices shipped: new `CITATIONS.md` doc (9 sections, ~370 lines) · root CLAUDE.md doc table + 2 new Working Principles · 12 × templates §11.6 Citations subsection · BRIEF.md Canonical NAP block in both reference impls · CHECKLIST.md 5 citation pre-launch items · SEO.md §8 cross-reference to CITATIONS.md · SALES.md §10 6-month audit deliverable · CHECKLIST.md Guard 6 added. Batch 3 (~22-28 hrs Full scope schema cookbook) next.)
...
| **SEO-DEPTH-EXPANSION-PLAN-2026-05-18.md** Batch 3 — schema cookbook (~41 per-vertical-per-archetype JSON-LD blocks + Full scope per §8 #1 resolution) | 🔄 **Ready to start** (~22-28 hrs Full scope; heaviest single batch in the plan) | Next session — recommend pausing first to validate the rules library against a real prospect (Café Del Corso or Laudam) before sinking 22-28 hrs into archetype-specific schemas that may not get used |
